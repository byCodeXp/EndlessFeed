...
export const App = () => {
   ...
   return (
       <div className="min-h-full bg-gray-200">
                   ...
                   <div className="flex gap-3">
                      <div className="flex-1 bg-purple-300 w-0">
                         <div className="bg-white py-4 px-8 rounded-lg shadow">
                            <label data-value=" " className="block w-full relative after:break-words after:content-[attr(data-value)] after:whitespace-pre-wrap overflow-hidden">
                                <textarea
                   ...
                   <div className="flex flex-col mt-4 gap-4">
                      <div className="p-4 bg-white rounded-lg shadow">
                         ...
                         <p className="mt-2 text-gray-800 text-md font-serif">
                            ...
                            nostrum tempore velit! Ab delectus dignissimos et ipsa maxime nam
                            rem? Ad, aliquam aut beatae cum cupiditate, deserunt dolores dolorum
                            eos incidunt iusto laudantium minus non nulla optio qui quos
                            sapiente sequi voluptate. Alias atque dolorem et ex facilis, illum
                            labore laboriosam nisi nobis nostrum rerum saepe similique sit sunt
                            voluptatibus?
                         </p>
                       ...
                       <div className="relative group">
                          ...
                          <div className="transition opacity-0 -translate-y-1/2 scale-0 group-hover:scale-100 group-hover:translate-y-0 group-hover:opacity-100 absolute left-1/2 -translate-x-1/2 overflow-hidden">
                             <ul className="bg-white rounded-lg mt-4">
                                ...
                                <li onClick={handleClickLogout} className="cursor-pointer w-24 py-1 text-center hover:bg-gray-100/50">Sign out</li>
                             </ul>
                          </div>
                       </div>
                   ) : (
          ...
          {formMode !== 'hidden' && (
              <div onClick={handleClickOutsideForm} className="fixed top-0 left-0 w-full h-full bg-gray-900/50 flex justify-center items-center">
                 <div ref={formRef} className="bg-gray-50 rounded-lg p-8 shadow-2xl">
                    {formMode === 'login' && (
                        <form onSubmit={handleSubmitForm}>
                           <div className="w-full text-center">Sign in account</div>
                           <div className="mt-6">
                              <input className="border w-64 outline-none bg-gray-100 shadow-inner rounded-lg p-2" type="text" placeholder="Email" />
                           </div>
                           <div className="mt-6">
                              <input className="border w-64 outline-none bg-gray-100 shadow-inner rounded-lg p-2" type="text" placeholder="Password" />
                           </div>
                           <div className="mt-6">
                              <button className="w-64 bg-sky-400 shadow-lg transition-shadow hover:shadow text-white hover:bg-sky-500 p-2 rounded-lg">Login</button>
                           </div>
                        </form>
                    )}
                    {formMode === 'register' && (
                        <form onSubmit={handleSubmitForm}>
                           <div className="w-full text-center">Creating new account</div>
                           <div className="mt-6">
                              <input className="border w-64 outline-none bg-gray-100 shadow-inner rounded-lg p-2" type="text" placeholder="Name" />
                           </div>
                           <div className="mt-6">
                              <input className="border w-64 outline-none bg-gray-100 shadow-inner rounded-lg p-2" type="text" placeholder="Email" />
                           </div>
                           ...
                           <div className="mt-6">
                              <button className="w-64 bg-sky-400 shadow-lg transition-shadow hover:shadow text-white hover:bg-sky-500 p-2 rounded-lg">Register</button>
                           </div>
                        </form>
                    )}
